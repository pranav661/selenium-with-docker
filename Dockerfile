...
ENTRYPOINT /usr/bin/java -cp /usr/share/tag/container-test.jar:/usr/share/tag/libs/* -DseleniumHubHost=34.80.100.196 -Dbrowser=chrome org.testng.TestNG /usr/share/tag/order-module
