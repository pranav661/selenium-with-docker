...
ENTRYPOINT /usr/bin/java -cp /usr/share/tag/container-test.jar:/usr/share/tag/libs/* -DseleniumHubHost=104.196.144.175 -Dbrowser=chrome org.testng.TestNG /usr/share/tag/order-module
